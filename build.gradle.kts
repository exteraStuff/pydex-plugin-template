...
extera {
    ...
    shadow {
        targetPackage = "ru.n08i40k.template_shaded"
    ...
    manifest {
        id = "exteragram-plugin-template"
        name = "exteraGram plugin template"
        description = "A template of exteraGram plugin with embedded DEX"
        author = "@n08i40k_extera"
        version = "0.0.0"
